const CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Gamma', desc:'Create stunning AI presentations, docs and websites in minutes. Full presentation from one prompt — no design skills needed.', url:'https://gamma.app', aff:'https://gamma.app?ref=aiportal', badge:'freemium', bestFor:'AI presentations, docs, websites', users:'5M+',
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Fiscal.ai', desc:'AI investment research platform (formerly FinChat). 100K+ companies, financial KPIs, earnings transcripts and AI analysis. Bloomberg-alternative for retail investors.', url:'https://fiscal.ai', aff:'https://fiscal.ai?ref=aiportal', badge:'freemium', bestFor:'Investment research, equity analysis, financial KPIs', users:'350K+',
      ...
      { name:'Koyfin', desc:'Professional Bloomberg-alternative financial terminal for retail investors. Real-time data on 90K+ securities, AI earnings summaries. Free; Plus $39/mo; Pro $79/mo.', url:'https://koyfin.com', aff:'https://koyfin.com?ref=aiportal', badge:'freemium', bestFor:'Financial research, stock analysis, Bloomberg alternative', users:'500K+',
