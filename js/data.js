const CATEGORIES = [
  {
    ...
    tools: [
      ...
      { name:'Gemini', desc:'Google\u2019s flagship AI with deepest Google Workspace integration. Gemini 2.5 Pro and Gemini 3 for subscribers. Most generous free tier in 2026.', url:'https://gemini.google.com', aff:'https://gemini.google.com?ref=aiportal', badge:'freemium', bestFor:'Google ecosystem, video/audio analysis', users:'100M+',
        pros:['Best Google Workspace integration — Gmail, Docs, Sheets, Drive native','Leading video and audio analysis with Veo 3.1 and Gemini 3','Most generous free tier: Deep Research + Gemini Live + 100 video credits/month','Gemini 3.1 Pro available on Ultra plan for power users'],
      ...
      { name:'Claude', desc:'AI assistant by Anthropic. Best for long documents, analysis and code. 1M token context window with Claude 4.', url:'https://claude.ai', aff:'https://claude.ai?ref=aiportal', badge:'freemium', bestFor:'Long texts, document analysis, code', users:'20M+',
        pros:['Best at following complex multi-step instructions without losing context','1M token context — analyze entire codebases, PDFs or book-length documents in one go','Fewest hallucinations of any frontier model — most accurate and careful','Web search and file uploads included on the free tier'],
        cons:['No image generation — Claude cannot render images, unlike ChatGPT or Gemini','Free tier limited to ~15–40 messages per 5-hour window on Sonnet 4.6'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Claude Code', desc:'Anthropic\'s CLI agent — the leading AI dev tool in 2026. Full cycle: code, tests, refactor in terminal.', url:'https://claude.ai/code', aff:'https://claude.ai/code?ref=aiportal', badge:'paid', bestFor:'Terminal, complex agentic tasks', users:'from $20/mo',
