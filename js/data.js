const CATEGORIES = [
  {
    ...
    tools: [
      ...
      { name:'ChatGPT', desc:'The world\u2019s most popular AI assistant, now powered by GPT-5.5 — natively omnimodal. Used by 200M+ people worldwide.', url:'https://chat.openai.com', aff:'https://chat.openai.com?ref=aiportal', badge:'freemium', bestFor:'General tasks, writing, coding, voice', users:'200M+',
        pros:['GPT-5.5 leads Terminal-Bench 2.0 — natively omnimodal','Best voice mode (Advanced Voice 2.0)','Widest feature set: DALL-E, Sora, Codex, Deep Research, Agent Mode'],
        cons:['Free and Go plans show ads in the US since Feb 2026','Claude beats ChatGPT on instruction-following and coding'] },
      { name:'Microsoft Copilot', desc:'AI assistant built into Windows 11, Edge and Microsoft 365. GPT-4o powered with Bing search. Free for all Windows users.', url:'https://copilot.microsoft.com', aff:'https://copilot.microsoft.com?ref=aiportal', badge:'freemium', bestFor:'Windows, Office 365, everyday tasks', users:'300M+',
      ...
      { name:'Gemini', desc:'Google\u2019s flagship AI with deepest Google Workspace integration. Gemini 3 leads in video/audio analysis. Most generous free tier in 2026.', url:'https://gemini.google.com', aff:'https://gemini.google.com?ref=aiportal', badge:'freemium', bestFor:'Google ecosystem, video/audio analysis', users:'100M+',
        pros:['Best Google Workspace integration — Gmail, Docs, Sheets, Drive native','Best video and audio analysis of any AI assistant','Most generous free tier: Deep Research + Gemini Live + 100 video credits/month'],
        cons:['Less precise than Claude on complex instruction-following','AI Ultra at $249.99/mo is the most expensive consumer AI tier'] },
