const CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      { name:'Notion AI', desc:'AI assistant built into Notion. IMPORTANT: Free and Plus plans are capped at 20 total AI responses lifetime. Business $20/user/mo for unlimited AI Agents. 100M users.', url:'https://notion.so', aff:'https://notion.so?ref=aiportal', badge:'freemium', bestFor:'Notes, knowledge base, AI agents in workspace', users:'100M+',
