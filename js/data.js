const CATEGORIES = [
  {
    ...
    tools: [
      { name:'Meta AI', desc:'Free AI assistant by Meta built into WhatsApp, Instagram and Messenger. Powered by Llama 4 Scout and Maverick. Over 1 billion monthly active users.', url:'https://meta.ai', aff:'https://meta.ai?ref=aiportal', badge:'free', bestFor:'Social media, everyday tasks, free chat', users:'1B+',
        pros:['Completely free with no usage limits or subscriptions','Built into WhatsApp, Instagram and Messenger — no extra app needed','Llama 4 Maverick is competitive with frontier models at zero cost','Real-time web search and image generation included for free'],
        cons:['Privacy concern — Meta uses conversations to improve ad targeting','Less capable than Claude or GPT-5.5 on complex multi-step reasoning tasks'] },
      { name:'ChatGPT', desc:'The world\u2019s most popular AI assistant with 1B+ monthly active users. GPT-5.5 is the default model. Free and Go tiers include ads (US, 2026). Plus $20/mo, Pro $100/mo.', url:'https://chat.openai.com', aff:'https://chat.openai.com?ref=aiportal', badge:'freemium', bestFor:'General tasks, writing, coding, image generation', users:'1B+',
        pros:['1B+ monthly active users — the most widely adopted AI assistant globally','GPT-5.5 default with strong reasoning, multimodal input, and web browsing','ChatGPT Images 2.0 for high-quality AI image generation'],
        cons:['Free and Go tiers now show contextual ads (US market, 2026)','Pro plans at $100–$200/month expensive for individual users'] },
      { name:'Microsoft Copilot', desc:'AI assistant built into Windows 11, Edge and Microsoft 365. GPT-5.2 powered with Bing search. Free for all Windows users.', url:'https://copilot.microsoft.com', aff:'https://copilot.microsoft.com?ref=aiportal', badge:'freemium', bestFor:'Windows, Office 365, everyday tasks', users:'300M+',
        pros:['Free for all Windows 11 users — no signup required','Deep Office 365 integration: works inside Word, Excel, Outlook, Teams','Bing search built-in for real-time, up-to-date answers','GPT-5.2 and Claude model option for drafting in Microsoft 365 apps'],
        cons:['Quality inconsistent compared to using ChatGPT or Claude directly','Full Microsoft 365 Copilot costs an extra $30/user/month on top of M365 subscription'] },
      { name:'Gemini', desc:'Google\u2019s flagship AI with deepest Google Workspace integration. Gemini 3.5 Flash (Google I/O 2026): flagship-class intelligence at Flash pricing. Most generous free tier in 2026.', url:'https://gemini.google.com', aff:'https://gemini.google.com?ref=aiportal', badge:'freemium', bestFor:'Google ecosystem, video/audio analysis', users:'100M+',
        pros:['Best Google Workspace integration — Gmail, Docs, Sheets, Drive native','Gemini 3.5 Flash brings flagship intelligence at fast-model speed and cost','Leading video and audio analysis with Veo 3 and native audio generation','Most generous free tier: Deep Research + Gemini Live + 100 video credits/month'],
        cons:['Less precise than Claude on complex instruction-following tasks','AI Ultra requires quarterly billing ($124.99/quarter, ~$42/mo) — no flexible monthly option at top tier'] },
      { name:'DeepSeek', desc:'Frontier-class Chinese AI completely free to use. DeepSeek V4 (April 2026): 1.6 trillion parameters, 1M context. Open-source weights available.', url:'https://chat.deepseek.com', aff:'https://chat.deepseek.com?ref=aiportal', badge:'free', bestFor:'Free frontier AI, open-source', users:'96M+',
        pros:['DeepSeek V4 matches GPT-5.5-class quality — completely free on web interface','Fully open-source weights available for local and commercial deployment','Exceptional math, coding and reasoning benchmarks at near-zero API cost','1M token context window on V4, same as leading paid models'],
        cons:['Chinese company — significant data privacy concerns for sensitive or confidential content','Servers can be slow or temporarily unavailable during peak global usage hours'] },
      { name:'Claude', desc:'AI assistant by Anthropic. Opus 4.8 (May 2026): 96.7% on USAMO math — the highest reasoning benchmark ever recorded. 1M token context. Free tier on Sonnet 4.6.', url:'https://claude.ai', aff:'https://claude.ai?ref=aiportal', badge:'freemium', bestFor:'Long texts, document analysis, code', users:'20M+',
        pros:['Opus 4.8 achieves 96.7% on USAMO 2026 — best math/reasoning score of any public model','Best at following complex multi-step instructions without losing context','1M token context — analyze entire codebases, PDFs or book-length documents in one go','Web search and file uploads included on the free tier'],
        cons:['No image generation — Claude cannot render images, unlike ChatGPT or Gemini','Free tier uses Sonnet 4.6 with ~15–40 messages per 5-hour window; Opus 4.8 requires Pro $20/mo'] },
      { name:'Grok', desc:'xAI\u2019s Grok 4.3 beta — 1 trillion parameters with real-time X/Twitter data. The only major AI with live social media integration.', url:'https://x.com/i/grok', aff:'https://x.com/i/grok?ref=aiportal', badge:'freemium', bestFor:'Real-time news, X/Twitter insights', users:'10M+',
        pros:['Real-time X/Twitter data — unique among all AI chatbots','1 trillion parameter scale — enormous model capacity','Less restrictive content policy than competitors'],
        cons:['SuperGrok Heavy at $300/mo — most expensive consumer AI subscription','Quality inconsistent vs Claude and GPT on reasoning tasks'] },
      { name:'Character.AI', desc:'Platform for creating and chatting with AI characters. 20M+ monthly active users for roleplay, storytelling and entertainment.', url:'https://character.ai', aff:'https://character.ai?ref=aiportal', badge:'freemium', bestFor:'AI character chat, roleplay, creative writing', users:'20M+',
        pros:['20M+ monthly active users with the largest library of AI characters available','Characters maintain persona and memory across long conversations without breaking character','Completely free with unlimited chat — no message limits on standard tier','c.ai Labs offers experimental interactive entertainment formats'],
      ...
      { name:'Mistral Le Chat', desc:'AI assistant by Mistral AI — Europe’s leading AI lab. Powered by Mistral Large 3, with web search, canvas, and image generation. Pro plan at $14.99/mo.', url:'https://chat.mistral.ai', aff:'https://chat.mistral.ai?ref=aiportal', badge:'freemium', bestFor:'Multilingual chat, European AI, GDPR-compliant', users:'5M+',
        pros:['Best-in-class multilingual support — particularly strong in European languages','Built on open-weight models (Mistral Large 3) — transparency and reproducibility','Free tier includes web search, image generation, and canvas with no signup friction','GDPR-compliant with EU data residency options for enterprise users'],
        cons:['Smaller plugin and integration ecosystem compared to ChatGPT or Gemini','Brand recognition lower outside Europe — community and third-party tooling still developing'] },
    ]
  },
  {
    ...
    tools: [
      ...
      { name:'AutoGPT', desc:'Open-source autonomous AI agent (2023). Largely superseded in 2026 by Claude Code, Cursor agents and Lovable. Still useful for learning AI agent architecture.', url:'https://agpt.co', aff:'https://agpt.co?ref=aiportal', badge:'free', bestFor:'Learning AI agents, open-source', users:'200K+',
        pros:['Fully open-source — inspect, fork and modify every component','Pioneer of autonomous AI agent category','Educational value for understanding agent architecture'],
        cons:['Largely superseded by Claude Code, Cursor and Lovable in 2026','Community activity significantly declined','Unreliable on complex tasks'] },
      ...
      { name:'Devin', desc:'World\'s first AI software engineer by Cognition. Autonomously plans, codes, debugs and deploys full features from a single prompt.', url:'https://cognition.ai/devin', aff:'https://cognition.ai/devin?ref=aiportal', badge:'paid', bestFor:'Autonomous coding, full-stack development, debugging', users:'from $20/mo',
        ...
        cons:['No free tier — minimum $20/month for 10 ACUs, usage-based beyond that','Complex tasks can be slow (30+ min) and sometimes require human course-correction'] },
    ]
  },
  {
    id: 'code', title: 'AI for Development', icon: '💻', color: '#2dd4a0',
    tools: [
      { name:'Replit', desc:'Cloud coding environment with AI agent that writes, runs and deploys code directly in the browser.', url:'https://replit.com', aff:'https://replit.com?ref=aiportal', badge:'freemium', bestFor:'Cloud coding, learning, quick deploys', users:'50M+',
      ...
      { name:'GitHub Copilot', desc:'AI code autocomplete inside your editor. Supports 40+ languages with GitHub integration.', url:'https://github.com/features/copilot', aff:'https://github.com/features/copilot?ref=aiportal', badge:'freemium', bestFor:'Autocomplete, IDE integration', users:'10M+',
      ...
      { name:'v0 by Vercel', desc:'Generates React/Tailwind UI components from text descriptions. Export directly to Next.js.', url:'https://v0.dev', aff:'https://v0.dev?ref=aiportal', badge:'freemium', bestFor:'UI components, React, prototypes', users:'6M+',
      ...
      { name:'Windsurf', desc:'VS Code-based AI code editor with Cascade agentic mode and codebase-wide semantic awareness via Codemaps. Proprietary SWE-1.5 model optimized for software engineering.', url:'https://windsurf.com', aff:'https://windsurf.com?ref=aiportal', badge:'freemium', bestFor:'Agentic coding, multi-file tasks, Cursor alternative', users:'1M+',
        pros:['Cascade agent mode highly capable for multi-step autonomous coding tasks','Proprietary SWE-1.5 model optimized specifically for software engineering','Codebase-wide semantic awareness via Codemaps keeps agent oriented in large projects','Clean VS Code-compatible interface — low-friction switch from VS Code or Cursor'],
        cons:['March 2026 pricing overhaul raised prices and changed billing structure','Acquisition by Cognition AI creates uncertainty about product direction','Heavy users can hit daily quota limits even on Pro plan'] },
      { name:'Cursor', desc:'VS Code-based IDE with built-in AI. Edit entire files with plain-text instructions.', url:'https://cursor.sh', aff:'https://cursor.sh?ref=aiportal', badge:'freemium', bestFor:'AI IDE, code refactoring', users:'1M+',
      ...
      { name:'Claude Code', desc:'Anthropic\'s CLI agent — the leading AI dev tool in 2026. Dynamic Workflows fan out up to 1,000 parallel subagents for repo-scale tasks.', url:'https://claude.ai/code', aff:'https://claude.ai/code?ref=aiportal', badge:'paid', bestFor:'Terminal, complex agentic tasks', users:'from $20/mo',
        pros:['Dynamic Workflows: fan out 1,000 parallel subagents for repo-scale tasks — new May 2026','Best at complex, long-context development tasks — entire repo in context','Terminal-native — works in any environment without IDE plugin','Handles complete feature cycles: design, code, tests, refactor autonomously'],
      ...
      { name:'OpenCode', desc:'Open-source MIT-licensed AI coding agent for the terminal. Supports 75+ LLM providers (Claude, GPT, Gemini, Grok, DeepSeek, local Ollama). 140K+ GitHub stars.', url:'https://opencode.ai', aff:'https://opencode.ai?ref=aiportal', badge:'free', bestFor:'Open-source CLI coding, terminal AI agent, multi-model', users:'N/A',
        pros:['100% MIT open source — full control, no vendor lock-in','75+ LLM providers supported out of the box, including local Ollama','Terminal-native (TUI) — fits vim/tmux/CLI workflows','Does not send your code to third-party servers'],
        cons:['No graphical IDE — terminal-only workflow has a learning curve','You bring your own LLM API keys; usage costs apply on top of any plan'] },
      { name:'Cline', desc:'Open-source VS Code extension for autonomous AI coding with step-by-step approval. Works with any LLM via your own API key. 59K+ GitHub stars, 5M+ installs.', url:'https://cline.bot', aff:'https://cline.bot?ref=aiportal', badge:'free', bestFor:'VS Code autonomous agent, BYOK, MCP tools', users:'5M+',
        pros:['Most widely installed open-source coding agent — 59K stars and 5M installs','Works inside your existing editor — no migration to a new IDE','Step-by-step approval keeps developer in control of every action','Native MCP support for custom tool integrations'],
        cons:['Approval workflow slows down complex multi-file tasks','No proprietary model — quality depends on your chosen LLM','BYOK means API costs managed separately'] },
      { name:'Aider', desc:'Open-source terminal AI pair programmer that auto-commits every change to git. Builds a repo map for large codebases. 40K+ stars, supports any LLM.', url:'https://aider.chat', aff:'https://aider.chat?ref=aiportal', badge:'free', bestFor:'Terminal coding, git-native workflow, large codebases', users:'5M+',
        pros:['Every AI change auto-committed to git — fully auditable and reversible','Repo map enables accurate multi-file edits across large projects','Connects to any LLM: Claude, GPT-4o, Gemini, DeepSeek, local Ollama'],
        cons:['Terminal-only — no GUI or IDE extension','Setup requires pip install and API key configuration','LLM API costs paid separately'] },
      { name:'Zed', desc:'Code editor built from scratch in Rust — the fastest available. Native real-time multiplayer, concurrent AI agents. 81K+ GitHub stars. Released v1.0 April 2026.', url:'https://zed.dev', aff:'https://zed.dev?ref=aiportal', badge:'freemium', bestFor:'Ultra-fast editor, multiplayer coding, concurrent AI agents', users:'500K+',
        pros:['Fastest code editor — sub-millisecond keystrokes built in Rust','Native real-time multiplayer without plugins','Concurrent AI agents on different codebase parts in same window','Free and open source — 81K+ GitHub stars'],
        cons:['Cannot run VS Code extensions — smaller ecosystem','Windows support still in progress as of mid-2026','Fewer community resources than established editors'] },
      { name:'Amazon Q Developer', desc:'AWS AI coding assistant with deep understanding of AWS services, IAM, CloudFormation, and CDK. Free tier includes unlimited completions + 50 agentic chats/month.', url:'https://aws.amazon.com/q/developer/', aff:'https://aws.amazon.com/q/developer/?ref=aiportal', badge:'freemium', bestFor:'AWS developers, cloud infrastructure, code transformation', users:'1M+',
        pros:['Deep AWS context — understands IAM, CloudFormation, CDK, and AWS services','Code transformation upgrades legacy codebases (Java 8→17, Python 2→3) automatically','Free tier: unlimited code completions + 50 agentic chats/month','Security vulnerability scanning built into the workflow'],
        cons:['Much less competitive outside of AWS development','Free tier limited to 50 agentic chats per month','Less value for GCP, Azure, or non-cloud projects'] },
      { name:'Kiro', desc:'Amazon\'s spec-driven agentic IDE. Write natural-language Specs, Kiro autonomously builds the full implementation. Replaced Amazon Q Developer IDE plugin from May 2026.', url:'https://kiro.dev', aff:'https://kiro.dev?ref=aiportal', badge:'freemium', bestFor:'Spec-driven agentic coding, AWS integration, autonomous implementation', users:'50K+',
        pros:['Specs: write natural-language requirements — agent builds the full implementation autonomously','Hooks: event-driven automation on file save and git commit for embedded quality gates','Built on Amazon Bedrock with access to Claude, Amazon Nova, and other foundation models','VS Code-compatible — existing extensions and keybindings work without migration','Deep AWS integration: provision infrastructure and deploy to AWS directly from the IDE'],
        cons:['Spec-driven workflow adds upfront overhead for small quick tasks','New product — ecosystem smaller and less mature than Cursor or Windsurf','Best suited for AWS-centric workloads; less value on other cloud providers'] },
    ]
  },
  {
    ...
    tools: [
      ...
      { name:'QuillBot', desc:'Free AI paraphrasing and summarizing tool. Rewrites text in 8 different styles, 125 words free per use.', url:'https://quillbot.com', aff:'https://quillbot.com?ref=aiportal', badge:'freemium', bestFor:'Paraphrasing, summarizing, rewriting', users:'50M+',
      ...
      { name:'Jasper', desc:'Professional AI copywriter for content teams. Brand Voice, 80+ templates, AI Campaign workflows. Starts at $49/month.', url:'https://jasper.ai', aff:'https://jasper.ai?ref=aiportal', badge:'paid', bestFor:'Marketing content, SEO writing', users:'100K+',
        pros:['Brand Voice learns your tone and applies it consistently across all content','80+ templates cover every marketing format from ads to full campaign briefs','AI Campaign generates complete multi-channel campaigns from a single brief','Surfer SEO integration for content optimization built into the workflow'],
        cons:['Starts at $49/month — expensive for individuals vs ChatGPT or Claude at $20/mo','Raw output quality similar to general-purpose LLMs — value is in templates and Brand Voice'] },
    ]
  },
  {
    id: 'marketing', title: 'Marketing & SEO', icon: '📈', color: '#e63946',
    tools: [
      { name:'Semrush', desc:'All-in-one SEO and AI visibility platform. Tracks rankings in Google, ChatGPT, Perplexity and Gemini. Semrush One from $199/mo.', url:'https://semrush.com', aff:'https://semrush.com?ref=aiportal', badge:'freemium', bestFor:'SEO research, competitor analysis', users:'10M+',
      ...
      { name:'Clearscope', desc:'Content optimization platform trusted by HubSpot, IBM and Adobe. Unlimited seats on all plans. Essentials $129/mo.', url:'https://clearscope.io', aff:'https://clearscope.io?ref=aiportal', badge:'paid', bestFor:'Content grading, keyword optimization', users:'50K+',
      ...
      { name:'Frase', desc:'AI research, content briefs and SEO optimization in one tool. Tracks AI visibility in ChatGPT, Perplexity and Gemini. Starter $49/mo.', url:'https://frase.io', aff:'https://frase.io?ref=aiportal', badge:'paid', bestFor:'Content briefs, SEO writing, SERP analysis', users:'30K+',
  ...
  // ── Creative & Media group: Image · Video · Design · Voice ───────────────────
  {
    ...
    tools: [
      ...
      { name:'ComfyUI', desc:'The most powerful open-source node-based AI image generation platform. Build full diffusion pipelines visually. Free, runs locally or in cloud.', url:'https://www.comfy.org', aff:'https://www.comfy.org?ref=aiportal', badge:'free', bestFor:'Advanced pipelines, game studios, custom models, production workflows', users:'10M+',
      ...
      { name:'ChatGPT Images 2.0', desc:'OpenAI\'s flagship image model — gpt-image-2, launched April 21, 2026 as the default in ChatGPT. Native reasoning, 2K resolution, character consistency across up to 8 images.', url:'https://chat.openai.com', aff:'https://chat.openai.com?ref=aiportal', badge:'freemium', bestFor:'Image generation, character consistency, prompt accuracy', users:'N/A',
        pros:['Native reasoning before generation — markedly better text, UI and dense composition rendering','Up to 2K resolution and aspect ratios 3:1 to 1:3','Thinking Mode generates up to 8 coherent images per prompt with character continuity','Replaces DALL·E 2/3 — accessible inside ChatGPT and via OpenAI API'],
        cons:['Thinking Mode features locked behind Plus / Pro / Business tiers','Free tier limited to Instant Mode (no batched multi-image generation)','Stylistic range still narrower than Midjourney for purely artistic work'] },
      { name:'DALL·E 3', desc:'OpenAI\'s image model built into ChatGPT and the API. Follows complex prompts with high accuracy and detail.', url:'https://openai.com/dall-e-3', aff:'https://openai.com/dall-e-3?ref=aiportal', badge:'freemium', bestFor:'Prompt-accurate images, ChatGPT integration', users:'10M+',
        ...
        cons:['More restrictive than Midjourney — refuses many creative or edgy requests','Less artistic range and control vs Midjourney or Stable Diffusion','Retiring May 12, 2026 — replaced by ChatGPT Images 2.0'] },
  ...
  },
  {
    ...
    tools: [
      { name:'CapCut', desc:'AI video editor with 800M+ monthly active users. Auto-captions, AI background removal, voice cloning, and Seedance 2.0 video generation. Pro $7.99/mo.', url:'https://capcut.com', aff:'https://capcut.com?ref=aiportal', badge:'freemium', bestFor:'Social media videos, reels, AI editing', users:'800M+',
        pros:['800M+ monthly active users — most widely used short-form video editor globally','Seedance 2.0 AI video generation integrated directly into editing workflow','Auto-captions with multilingual translation and AI background removal built in'],
        cons:['ByteDance ownership creates US regulatory risk — potential ban exposure','Free tier exports have a visible CapCut watermark requiring paid plan to remove','Seedance 2.0 AI video generation not available in the United States (legal issues)'] },
      { name:'Kling AI', desc:'Kling 3.0 (Feb 2026): native 4K, storyboard tool, lip-synced audio, subject consistency. Free 66 credits/day. Pro from $6.99/mo.', url:'https://klingai.com', aff:'https://klingai.com?ref=aiportal', badge:'freemium', bestFor:'Long videos, motion physics', users:'60M+',
      ...
      { name:'Runway', desc:'Gen-4.5 is #1 on video leaderboards (Nov 2025). One subscription: Runway + Veo 3.1 + Kling 3.0 + Seedance + FLUX. From $15/mo.', url:'https://runwayml.com', aff:'https://runwayml.com?ref=aiportal', badge:'freemium', bestFor:'Cinematic video, professionals', users:'3M+',
      ...
      { name:'HeyGen', desc:'AI avatars and video dubbing in 175+ languages. Avatar IV with ultra-realistic lip-sync. $100M ARR. Starts at $24/month.', url:'https://heygen.com', aff:'https://heygen.com?ref=aiportal', badge:'freemium', bestFor:'Avatars, dubbing, marketing', users:'2M+',
      ...
      { name:'Pika', desc:'Pika 2.5: Pikaframes controls exact start/end frames for AI video transitions. 80 free monthly credits. Best for social-first video effects.', url:'https://pika.art', aff:'https://pika.art?ref=aiportal', badge:'freemium', bestFor:'Short clips, creative effects, social', users:'2M+',
      ...
      { name:'Seedance 2.0', desc:'ByteDance\'s next-gen AI video model — unified multimodal audio-video joint generation. 1080p, native lip-sync in 8+ languages, multi-shot videos up to 15 seconds.', url:'https://seed.bytedance.com/en/seedance2_0', aff:'https://seed.bytedance.com/en/seedance2_0?ref=aiportal', badge:'freemium', bestFor:'AI video, audio-video joint generation, lip-sync', users:'N/A',
        pros:['Unified audio-video generation — synchronized natively, not as post-processing','Phoneme-level lip-sync in 8+ languages','Up to 15-second multi-shot videos at 1080p with natural cuts','Supports text, image, audio and video as input references'],
        cons:['ByteDance infrastructure — data privacy considerations for Western enterprises','Higher tier pricing up to $167/month for full output volumes'] },
      { name:'Luma AI', desc:'Luma Ray3 and Ray3.14 generate cinematic AI video. Dream Machine branding retired. Best for atmosphere and environment-heavy shots. Freemium.', url:'https://lumalabs.ai', aff:'https://lumalabs.ai?ref=aiportal', badge:'freemium', bestFor:'Realistic video, 3D scenes, Dream Machine', users:'5M+',
      ...
      { name:'Synthesia', desc:'Synthesia 3.0: Video Agents for real-time two-way avatar conversations. 160+ avatars, 140+ languages. $22/month. 50K+ companies.', url:'https://synthesia.io', aff:'https://synthesia.io?ref=aiportal', badge:'paid', bestFor:'Corporate video, training, multilingual presenters', users:'50K+ companies',
  ...
  },
  {
    ...
    tools: [
      { name:'Canva AI', desc:'Canva AI 2.0 (April 2026): full AI creative partner from idea to final design. Magic Studio, agentic capabilities, 220M+ users. Pro $15/mo.', url:'https://canva.com', aff:'https://canva.com?ref=aiportal', badge:'freemium', bestFor:'Social media, presentations, marketing', users:'220M+',
        pros:['220M+ monthly users — most popular design tool with the largest template library','Canva AI 2.0: agentic workflow handles research, writing, design and scheduling via chat','Magic Resize reformats any design for any platform in one click','Free tier genuinely capable — no subscription needed for most casual use'],
      ...
      { name:'Framer AI', desc:'Create landing pages from text descriptions with animations. Publish in one click. Free → Basic $15 → Pro $45 → Scale $100/mo.', url:'https://framer.com', aff:'https://framer.com?ref=aiportal', badge:'freemium', bestFor:'Landing pages, portfolio sites', users:'1M+',
      ...
      { name:'Whimsical AI', desc:'Visual collaboration tool for AI-generated flowcharts, mind maps, and wireframes from text prompts. 4M+ users. Free; Pro $10/editor/mo.', url:'https://whimsical.com', aff:'https://whimsical.com?ref=aiportal', badge:'freemium', bestFor:'Flowcharts, mind maps, wireframes from text', users:'4M+',
        pros:['AI generates complete flowcharts, mind maps, and wireframes from text descriptions','4M+ users with strong adoption in product and design teams','Pro at $10/editor/mo very affordable compared to diagramming alternatives'],
        cons:['Not a full UI design tool — less capable than Figma for detailed component design','Free plan watermark limits professional use without upgrading'] },
    ]
  },
  {
    ...
    tools: [
      ...
      { name:'Suno', desc:'Suno v4.5 (2026): AI music in any genre with commercial rights. WMG partnership resolves copyright. Pro $10/mo, Premier $30/mo with Studio DAW.', url:'https://suno.ai', aff:'https://suno.ai?ref=aiportal', badge:'freemium', bestFor:'Fast music generation', users:'10M+',
      ...
      { name:'ElevenLabs', desc:'Best TTS with voice cloning in 32+ languages. Eleven Music on licensed content, conversational AI agents. $11B valuation. Creator $22/mo, Pro $99/mo.', url:'https://elevenlabs.io', aff:'https://elevenlabs.io?ref=aiportal', badge:'freemium', bestFor:'Voice cloning, TTS, voiceover', users:'5M+',
      ...
      { name:'Murf AI', desc:'AI voice generator with 200+ voices in 35+ languages for e-learning, explainer videos, and corporate presentations. 1M+ users. Free 10min; Creator $19/mo; Business $66/mo.', url:'https://murf.ai', aff:'https://murf.ai?ref=aiportal', badge:'freemium', bestFor:'E-learning voiceovers, explainer videos, presentations', users:'1M+',
        pros:['200+ voices in 35+ languages with style and emotion controls','Built-in video editor syncs voiceover to slides and video clips','Creator plan at $19/mo provides commercial rights and full voice library'],
        cons:['Free tier only 10 minutes/month — barely sufficient for testing','Voice cloning locked behind Business plan at $66/month'] },
    ]
  },
  {
    id: 'productivity', title: 'Productivity', icon: '⚡', color: '#f5a623',
    tools: [
      { name:'Notion AI', desc:'Notion 3.0+ with AI Agents, Workers for Agents (April 2026), GPT-5.4/Claude Opus/Gemini 3 support, meeting transcription and image generation built in.', url:'https://notion.so', aff:'https://notion.so?ref=aiportal', badge:'freemium', bestFor:'Notes, knowledge base, AI agents in workspace', users:'100M+',
        pros:['Native AI within the Notion workspace — no switching tools','AI Agents automate multi-step Notion workflows autonomously','Ask AI searches across all workspace content'],
        cons:['Free and Plus plans: only 20 LIFETIME total AI responses — essentially non-functional','Business plan at $20/user/mo required for unlimited AI — expensive per seat'] },
      ...
      { name:'Gamma', desc:'Gamma 3.0 (Sep 2025): Gamma Agent edits decks via natural language. Gamma Imagine (Mar 2026) for marketing assets. 70M+ users. Plus $8/mo.', url:'https://gamma.app', aff:'https://gamma.app?ref=aiportal', badge:'freemium', bestFor:'Presentations, pitch decks, visual docs', users:'70M+',
  ...
  },
  {
    ...
    tools: [
      { name:'Perplexity', desc:'AI search engine with cited sources. 45M+ monthly users, $20B valuation. Deep Research for multi-page analysis. Pro $20/mo.', url:'https://perplexity.ai', aff:'https://perplexity.ai?ref=aiportal', badge:'freemium', bestFor:'Research with citations', users:'45M+',
      ...
      { name:'NotebookLM', desc:'Google\'s AI notebook. Cinematic Video Overviews (March 2026), slide editing, EPUB support. Free; Plus via Google AI Pro $19.99/mo.', url:'https://notebooklm.google.com', aff:'https://notebooklm.google.com?ref=aiportal', badge:'free', bestFor:'PDF analysis, summaries, Q&A', users:'5M+',
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Julius AI', desc:'AI data analyst — upload CSV or connect database for charts and insights. Learning Sub Agent adapts to your data. Pro from $20/mo.', url:'https://julius.ai', aff:'https://julius.ai?ref=aiportal', badge:'freemium', bestFor:'CSV analysis, data visualization', users:'500K+',
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Lovable', desc:'Build full-stack web apps from text descriptions. Agent Mode builds and verifies changes autonomously. React + Supabase, deploy in one click.', url:'https://lovable.dev', aff:'https://lovable.dev?ref=aiportal', badge:'freemium', bestFor:'Full-stack apps, SaaS MVPs', users:'500K+',
      ...
      { name:'FlutterFlow', desc:'Visual Flutter app builder. One-click App Store deploy, GitHub integration. Basic $39/mo. August 2025 pricing restructure.', url:'https://flutterflow.io', aff:'https://flutterflow.io?ref=aiportal', badge:'freemium', bestFor:'Mobile apps, iOS/Android, native performance', users:'500K+',
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Gamma', desc:'Gamma 3.0: Gamma Agent edits decks via natural language. Gamma Imagine (Mar 2026) for marketing assets. 70M+ users, $2.1B valuation. Plus $8/mo.', url:'https://gamma.app', aff:'https://gamma.app?ref=aiportal', badge:'freemium', bestFor:'AI presentations, docs, websites', users:'70M+',
        pros:['Full presentation from one prompt in seconds — beautiful design automatically','Export to PDF, PowerPoint and Google Slides','Built-in analytics — see who viewed and how long','Web-native — interactive presentations with embedded media'],
        cons:['Free plan adds watermark','Less manual design control than PowerPoint or Figma'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { name:'Fiscal.ai', desc:'AI investment research (formerly FinChat). S&P Market Intelligence data on 100K+ companies, 13F hedge fund analysis, DCF modeling. Plus $24/mo, Pro $64/mo.', url:'https://fiscal.ai', aff:'https://fiscal.ai?ref=aiportal', badge:'freemium', bestFor:'Investment research, equity analysis, financial KPIs', users:'350K+',
        pros:['Institutional-grade data on 100K+ companies with AI-generated cited answers','Earnings transcript analysis — AI extracts key statements and management tone','Plus $24/mo is significantly cheaper than Bloomberg or FactSet alternatives'],
        cons:['Public companies only — no private company or alternative data','Pro at $64/mo required for advanced institutional-grade features'] },
      ...
      { name:'Koyfin', desc:'Professional Bloomberg-alternative terminal. 5,900+ screening criteria, customizable dashboards, 500K+ users. Free → $110/mo retail, $199/mo Advisor Pro.', url:'https://koyfin.com', aff:'https://koyfin.com?ref=aiportal', badge:'freemium', bestFor:'Financial research, stock analysis, Bloomberg alternative', users:'500K+',
        pros:['Professional Bloomberg-alternative at 95% lower cost ($39-79/mo vs $24K/yr Bloomberg)','90K+ securities with real-time data, fundamentals, and earnings transcripts','AI earnings call summaries save hours of transcript reading'],
        cons:['Real-time tick data and depth trails Bloomberg for professional trading','International market coverage less comprehensive than US equities'] },
    ]
  }
];
