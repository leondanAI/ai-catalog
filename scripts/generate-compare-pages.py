...
(function() {{
  ...
  var LABELS = {{
    ...
    fr: {{ov:'Aperçu',pr:'Prix',us:'Utilisateurs',bf:'Idéal pour',rt:'Évaluation',ad:'Avantages',ds:'Inconvénients',wb:'Site web',vt:'Visiter',rv:'Avis complet',nr:'Pas encore d\'avis'}},
