...
LANGUAGES = {
    'ru': {
        ...
        'ui':  {'about':'О сервисе','pros':'Преимущества','cons':'Недостатки','also':'Также рассмотрите',
                ...
                'footer_nav':'Навигация','footer_cats':'Категории','made':'Сделано с ♥ и Claude · Обновляется регулярно',
    ...
    'es': {
        ...
        'ui':  {'about':'Acerca de','pros':'Ventajas','cons':'Desventajas','also':'También considera',
                ...
                'footer_nav':'Navegación','footer_cats':'Categorías','made':'Hecho con ♥ y Claude · Actualizado regularmente',
    ...
    'fr': {
        ...
        'ui':  {'about':'À propos de','pros':'Avantages','cons':'Inconvénients','also':'À considérer aussi',
                ...
                'footer_nav':'Navigation','footer_cats':'Catégories','made':'Fait avec ♥ et Claude · Mis à jour régulièrement',
    ...
    'pt': {
        ...
        'ui':  {'about':'Sobre','pros':'Vantagens','cons':'Desvantagens','also':'Considere também',
                ...
                'footer_nav':'Navegação','footer_cats':'Categorias','made':'Feito com ♥ e Claude · Atualizado regularmente',
    ...
    'de': {
        ...
        'ui':  {'about':'Über','pros':'Vorteile','cons':'Nachteile','also':'Auch erwägen',
                ...
                'footer_nav':'Navigation','footer_cats':'Kategorien','made':'Gemacht mit ♥ und Claude · Regelmäßig aktualisiert',
    ...
    'uk': {
        ...
        'ui':  {'about':'Про сервіс','pros':'Переваги','cons':'Недоліки','also':'Також розгляньте',
                ...
                'footer_nav':'Навігація','footer_cats':'Категорії','made':'Зроблено з ♥ та Claude · Оновлюється регулярно',
