...
def render_page(tool, all_tools, lang, L, trans, ratings):
    ...
    TOOL_COMPARE = {
        ...
        # Agents
        'microsoft-copilot-studio': ('copilot-studio-vs-manus',         'Manus'),
        'manus':                    ('copilot-studio-vs-manus',         'Copilot Studio'),
        'n8n':                      ('n8n-vs-copilot-studio',           'Copilot Studio'),
        'make':                     ('make-vs-n8n',                     'n8n'),
        'lindy':                    ('lindy-vs-copilot-studio',         'Copilot Studio'),
        'relevance-ai':             ('relevance-ai-vs-copilot-studio',  'Copilot Studio'),
        'devin':                    ('devin-vs-copilot-studio',         'Copilot Studio'),
        # Code
        'cursor':                   ('cursor-vs-copilot',               'GitHub Copilot'),
        'github-copilot':           ('cursor-vs-copilot',               'Cursor'),
        'windsurf':                 ('windsurf-vs-cursor',              'Cursor'),
        'claude-code':              ('claude-code-vs-github-copilot',   'GitHub Copilot'),
        'replit':                   ('replit-vs-github-copilot',        'GitHub Copilot'),
        'bolt-new':                 ('bolt-new-vs-cursor',              'Cursor'),
        'v0-by-vercel':             ('v0-by-vercel-vs-cursor',          'Cursor'),
        'cline':                    ('cline-vs-github-copilot',         'GitHub Copilot'),
        'aider':                    ('aider-vs-github-copilot',         'GitHub Copilot'),
        # Writing
        'deepl':                    ('deepl-vs-grammarly',              'Grammarly'),
        'grammarly':                ('deepl-vs-grammarly',              'DeepL'),
        'quillbot':                 ('quillbot-vs-grammarly',           'Grammarly'),
        'jasper':                   ('jasper-vs-writesonic',            'Writesonic'),
        'writesonic':               ('writesonic-vs-grammarly',         'Grammarly'),
        'hemingway-editor':         ('hemingway-editor-vs-grammarly',   'Grammarly'),
        # Marketing
        'semrush':                  ('semrush-vs-copy-ai',              'Copy.ai'),
        'copy-ai':                  ('semrush-vs-copy-ai',              'Semrush'),
        'surferseo':                ('surferseo-vs-semrush',            'Semrush'),
        'frase':                    ('frase-vs-semrush',                'Semrush'),
        'clearscope':               ('clearscope-vs-surferseo',         'SurferSEO'),
        # Image
        'midjourney':               ('midjourney-vs-stable-diffusion',  'Stable Diffusion'),
        'stable-diffusion':         ('midjourney-vs-stable-diffusion',  'Midjourney'),
        'flux':                     ('midjourney-vs-flux',              'Midjourney'),
        'ideogram':                 ('ideogram-vs-midjourney',          'Midjourney'),
        'adobe-firefly':            ('adobe-firefly-vs-midjourney',     'Midjourney'),
        'recraft-ai':               ('recraft-ai-vs-midjourney',        'Midjourney'),
        'leonardo-ai':              ('leonardo-ai-vs-midjourney',       'Midjourney'),
        # Video
        'capcut':                   ('capcut-vs-kling-ai',              'Kling AI'),
        'kling-ai':                 ('kling-vs-runway',                 'Runway'),
        'runway':                   ('runway-vs-capcut',                'CapCut'),
        'heygen':                   ('heygen-vs-synthesia',             'Synthesia'),
        'synthesia':                ('heygen-vs-synthesia',             'HeyGen'),
        'pika':                     ('pika-vs-kling-ai',                'Kling AI'),
        'luma-ai':                  ('luma-ai-vs-runway',               'Runway'),
        'google-veo-3':             ('google-veo-3-vs-runway',          'Runway'),
        # Design
        'canva-ai':                 ('canva-ai-vs-figma-ai',            'Figma AI'),
        'figma-ai':                 ('figma-ai-vs-canva-ai',            'Canva AI'),
        'framer-ai':                ('framer-ai-vs-canva-ai',           'Canva AI'),
        'looka':                    ('looka-vs-canva-ai',               'Canva AI'),
        'uizard':                   ('uizard-vs-figma-ai',              'Figma AI'),
        'uxpilot':                  ('uxpilot-vs-figma-ai',             'Figma AI'),
        'relume':                   ('relume-vs-framer-ai',             'Framer AI'),
        'whimsical-ai':             ('whimsical-ai-vs-figma-ai',        'Figma AI'),
        # Voice
        'speechify':                ('speechify-vs-elevenlabs',         'ElevenLabs'),
        'elevenlabs':               ('speechify-vs-elevenlabs',         'Speechify'),
        'murf-ai':                  ('elevenlabs-vs-murf-ai',           'ElevenLabs'),
        'playht':                   ('elevenlabs-vs-playht',            'ElevenLabs'),
        'descript':                 ('descript-vs-adobe-podcast',       'Adobe Podcast'),
        'adobe-podcast':            ('descript-vs-adobe-podcast',       'Descript'),
        'suno':                     ('suno-vs-udio',                    'Udio'),
        'udio':                     ('suno-vs-udio',                    'Suno'),
        # Productivity
        'notion-ai':                ('notion-ai-vs-zapier-ai',          'Zapier AI'),
        'zapier-ai':                ('zapier-ai-vs-make',               'Make'),
        'gamma':                    ('gamma-vs-notion-ai',              'Notion AI'),
        'otter-ai':                 ('otter-ai-vs-fireflies-ai',        'Fireflies.ai'),
        'fireflies-ai':             ('otter-ai-vs-fireflies-ai',        'Otter.ai'),
        'motion':                   ('motion-vs-reclaim-ai',            'Reclaim.ai'),
        'reclaim-ai':               ('motion-vs-reclaim-ai',            'Motion'),
        # Research
        'perplexity':               ('perplexity-vs-notebooklm',        'NotebookLM'),
        'notebooklm':               ('perplexity-vs-notebooklm',        'Perplexity'),
        'elicit':                   ('elicit-vs-consensus',             'Consensus'),
        'consensus':                ('consensus-vs-perplexity',         'Perplexity'),
        'humata':                   ('notebooklm-vs-humata',            'NotebookLM'),
        'scite':                    ('scite-vs-semantic-scholar',       'Semantic Scholar'),
        'semantic-scholar':         ('scite-vs-semantic-scholar',       'Scite'),
        # Data
        'looker-studio':            ('looker-studio-vs-tableau-ai',     'Tableau AI'),
        'tableau-ai':               ('looker-studio-vs-tableau-ai',     'Looker Studio'),
        'julius-ai':                ('julius-ai-vs-looker-studio',      'Looker Studio'),
        'hex':                      ('hex-vs-looker-studio',            'Looker Studio'),
        'rows':                     ('rows-vs-hex',                     'Hex'),
        'retool-ai':                ('retool-ai-vs-looker-studio',      'Looker Studio'),
        # No-Code
        'bubble':                   ('bubble-vs-webflow',               'Webflow'),
        'webflow':                  ('bubble-vs-webflow',               'Bubble'),
        'lovable':                  ('lovable-vs-bubble',               'Bubble'),
        'flutterflow':              ('flutterflow-vs-bubble',           'Bubble'),
        'glide':                    ('glide-vs-bubble',                 'Bubble'),
        'softr':                    ('softr-vs-bubble',                 'Bubble'),
        # Education
        'photomath':                ('photomath-vs-duolingo-max',       'Duolingo Max'),
        'duolingo-max':             ('duolingo-max-vs-khanmigo',        'Khanmigo'),
        'khanmigo':                 ('khanmigo-vs-photomath',           'Photomath'),
        'youlearn':                 ('youlearn-vs-notebooklm',          'NotebookLM'),
        'synthesis':                ('synthesis-vs-khanmigo',           'Khanmigo'),
        # Presentations
        'beautiful-ai':             ('beautiful-ai-vs-pitch',           'Pitch'),
        'pitch':                    ('gamma-vs-pitch',                  'Gamma'),
        'prezi':                    ('gamma-vs-prezi',                  'Gamma'),
    ...
    COMPARE_LABELS = {
        ...
        'es': ('📊 ¿Cómo se compara {}?', 'Ver todas'),
        'de': ('📊 Wie schneidet {} ab?', 'Alle Vergleiche'),
        'ua': ('📊 Як порівнюється {}?', 'Всі порівняння'),
        'he': ('📊 כיצד {} משתווה?', 'כל ההשוואות'),
        'fr': ('📊 Comment se compare {} ?', 'Toutes les comparaisons'),
        'pt': ('📊 Como se compara {}?', 'Todas as comparações'),
    }
    ...
    if _cmp:
        ...
        lbl_q, lbl_all = COMPARE_LABELS.get(lang, ('📊 Compare {}', 'All comparisons'))
        base = f'/{lang}'
        cmp_word = {'ru':'Сравнить','es':'Comparar','de':'Vergleichen','ua':'Порівняти','he':'להשוות','fr':'Comparer','pt':'Comparar'}.get(lang,'Compare')
        compare_strip = (
            f'<span class="compare-strip">'
            f'⚖️ {cmp_word} '
            f'<a href="{base}/compare/{esc(cmp_slug)}.html" class="compare-strip-link">'
        ...
        compare_footer = (
            ...
            f'<a href="{base}/compare/{esc(cmp_slug)}.html">{esc(name)} vs {esc(cmp_other)}</a>'
            f'<a href="{base}/compare.html">{lbl_all}</a>'
            f'</div>'
            f'</div>'
        )
...
.tool-action-bar{{display:flex;align-items:center;justify-content:space-between;background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:10px 16px;margin-top:16px;margin-bottom:1.5rem;min-height:42px;flex-wrap:wrap;gap:8px}}.compare-strip{{display:inline-flex;align-items:center;gap:5px;font-size:13px;color:var(--text2);white-space:nowrap}}.compare-strip-link{{color:var(--accent);font-weight:600;text-decoration:none}}.compare-strip-link:hover{{text-decoration:underline}}
...
<div class="tool-page">
  ...
  <div class="tool-action-bar">
    <div id="ratingDisplay" style="display:flex;align-items:center;gap:5px;min-height:22px"></div>
    {compare_strip}
  </div>
  ...
  <div class="footer-inner">
    ...
    <div>
      ...
      <div class="footer-col-links">
        ...
        <a href="/{lang}/directory.html" style="color:var(--accent);margin-top:4px">More →</a>
      </div>
    </div>
    {compare_footer}
  </div>
