...
def render_page(tool, all_tools, lang, L, trans, ratings):
    ...
    if _cmp:
        ...
        compare_strip = (
            f'<a href="{base}/compare/{esc(cmp_slug)}.html" class="compare-strip">'
            f'⚖️ {cmp_word} {esc(name)} vs {esc(cmp_other)}'
            f'</a>'
        )
        compare_footer = (
            f'<div>'
