...
<div class="tool-page">
  ...
  <div style="display:flex;align-items:center;gap:5px;margin-bottom:1.5rem">
    <span style="color:#f59e0b;font-size:13px;letter-spacing:1px">★★★★</span><span style="color:#555;font-size:13px">★</span>
    <span style="font-size:13px;font-weight:600;color:#f0f0f0">—</span>
  </div>
